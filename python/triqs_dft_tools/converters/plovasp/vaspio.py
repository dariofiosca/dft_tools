...
class VaspData:
    ...
    def __init__(self, vasp_dir, read_all=True, efermi_required=True):
        ...
        if vasptriqs:
            ...
            self.h5path = os.path.join(vasp_dir, 'vasptriqs.h5')
            self.plocar = h5Plocar()
            self.poscar = h5Poscar()
            self.kpoints = h5Kpoints()
            self.eigenval = h5Eigenval()
            self.doscar = h5Doscar()
        else:
            self.plocar = Plocar()
            self.poscar = Poscar()
